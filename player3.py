...
class Player(pygame.sprite.Sprite):
    def __init__(self, position):
        self.bobby = pygame.Rect(level3.playerPosX, level3.playerPosY, 27, 40)
    ...
    def move_single_axis(self, dx, dy, especial):
        ...
        self.bobby.x += dx
        self.bobby.y += dy
        level3.caja.caja1HitBox.x = level3.caja.caja1.x - 5
        level3.caja.caja2HitBox.x = level3.caja.caja2.x - 5
        level3.caja.caja3HitBox.x = level3.caja.caja3.x - 5
        level3.caja.caja1HitBox.y = level3.caja.caja1.y - 5
        level3.caja.caja2HitBox.y = level3.caja.caja2.y - 5
        level3.caja.caja3HitBox.y = level3.caja.caja3.y - 5
        level3.colision(dx, dy, especial)
